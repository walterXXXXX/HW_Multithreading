...
public:
    explicit DecoratedText(std::shared_ptr<Text> text) : Text(text->getOutput()), text_(text) {}
protected:
...
int main() { 
    ...
    link_block->render("netology.ru", message);
    output << std::endl;
}